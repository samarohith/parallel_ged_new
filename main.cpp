...
void find_ged0(int id, const int start)
{
...
void find_ged1(int id, const int start)
{
...
int main(int argc, char** argv)
{
	...
	if(argc > 8) num_threads = atoi(argv[argc-2]);
	else num_threads = atoi(argv[argc-1]);
	cout<<"\nthreads = "<<num_threads<<endl;
	thread_work = gdb_size/num_threads;
